/* 
Simple application inserting Movie in the movies collection of MongoDB
...
func main() {
	...
	// fetch a collection using DB and C functions in a chained manner 
	...
	// a translator that can convert a normal filter query to the MongoDB understandable query
