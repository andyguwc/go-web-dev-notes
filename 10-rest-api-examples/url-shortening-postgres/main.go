/* URL Shortening Service using Postgres
...
import (
	...
	_ "github.com/lib/pq"
	"github.com/andyguwc/go-resources/10-rest-api-examples/url-shortening-postgres/models"
	base62 "github.com/andyguwc/go-resources/10-rest-api-examples/url-shortening-postgres/utils"
...
// curl -X POST http://localhost:8000/v1/short -H 'cache-control: no-cache' -H 'content-type: application/json' -d '{"url":"https://www.forbes.com"}'
